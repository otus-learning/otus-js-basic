...
export const IFRAME_ID = "iframeId";
export const HISTORY_DIV_ID = "historyId";
export const IMG_ID = "imgId";
export const TEMP_P_ID = "tempId";
export const DESCRIPTION_P_ID = "descId";
export const HUMIDITY_P_ID = "humId";
export const WIND_P_ID = "windId";
export const FORECAST_ID = "forecastId";
