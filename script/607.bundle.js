"use strict";
(self["webpackChunkotus_learning"] = self["webpackChunkotus_learning"] || []).push([[607],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".header-block{display:flex;justify-content:center;flex-flow:row wrap;gap:1%;margin:1%}.header-block__img{width:20%;object-fit:contain;min-width:250px}.header-block__text{text-align:right;width:30%}.navigation{font-size:2rem;display:flex;gap:5%;width:40%}.navigation__link{width:25%}.main-block{margin:1%;display:flex;flex-flow:row wrap;justify-content:space-evenly;gap:3%}.main-block__text-block--centered{width:70%}.main-block__text-block--left-right{width:15%}.text-block{min-width:20rem}.text-block__p--margined{margin-bottom:4rem}.text-block__p--margined::first-letter{color:red;font-style:italic;font-size:1.1rem}.footer-block{margin:1%;display:flex;flex-flow:row;justify-content:space-evenly;gap:3%}", ""]);
// Exports
