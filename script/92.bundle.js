"use strict";
(self["webpackChunkotus_learning"] = self["webpackChunkotus_learning"] || []).push([[92],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root{font-size:16px}*{box-sizing:border-box}html,body{background-color:#fff;line-height:1.2}", ""]);
// Exports
