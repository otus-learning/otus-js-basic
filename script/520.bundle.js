...
class Carousel {
  //parent container
  #el; //index of current picture

  index; //count of all included items

  count; //container with count visualisation

  #countEl; //count items and return it's visual presentation
  ...
  constructor(el, urls) {
    ...
    this.#countEl.classList.add("carousel-count"); //creating left control arrow
    ...
    left.addEventListener("click", () => {
      ...
      this.#countEl.innerHTML = Carousel.#changeCount(this.#countEl.innerHTML, this.index);
    ...
    el.parentNode.appendChild(this.#countEl); //adding declarative items defined on page
  ...
  remove(idx) {
    ...
    if (this.#el.querySelector(".carousel__item--active") === null && items.length) {
      this.index > 0 && this.index--;
      items[this.index].classList.add("carousel__item--active");
    }

    this.#countEl.innerHTML = this.#countEl.innerHTML.substring(0, this.#countEl.innerHTML.length - 1);
    this.#countEl.innerHTML = Carousel.#changeCount(this.#countEl.innerHTML, this.index);
  }
